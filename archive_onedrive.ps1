...
$source_site_id = Read-Host "Please enter the source site ID (=last part of OneDrive URL, e.g. 'thomas_dereyck_manuchar_com')."
$target_site_id = Read-Host "Please enter the target site ID."
